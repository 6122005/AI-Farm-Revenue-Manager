...
from app.services.person_increment_engine import IntelligentPersonIncrementEngine
...
print("Context Standard Capacity:", context.standard_capacity)
print("Requested Guests:", req["person_count"])
