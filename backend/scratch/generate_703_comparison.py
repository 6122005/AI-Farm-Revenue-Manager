...
print(f"Loaded {len(df_clean)} records after filtering extended day, festival, and outliers.")
...
for idx, row in df_clean.iterrows():
    ...
    # End datetime estimate based on duration
...
print(f"Saved full {len(res_df)} records to {csv_out_path}")
