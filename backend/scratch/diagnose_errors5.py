...
# Load Model
artifact = joblib.load("/Users/darshankanani/AI-Farm-Revenue-Manager/backend/app/models/saved/champion_model.joblib")
...
cols_to_show = ["booking_date", "commercial_slot", "person_count", "selling_price", "historical_baseline_price", "predicted", "error", "abs_error"]
