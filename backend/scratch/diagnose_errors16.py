...
# Explicitly do NOT drop outliers
...
# Keep person_count, lead_days, and DO NOT drop z-score!
...
# Add a heavy vacation_weekend interaction feature!
X_train["vacation_weekend"] = X_train["is_vacation"] * X_train["is_weekend"]
X_test["vacation_weekend"] = X_test["is_vacation"] * X_test["is_weekend"]
features.append("vacation_weekend")
...
print(f"R² (NO outlier drop + Vacation Interaction): {r2_score(y_test, preds_B):.4f}")
